...
public class Tools_CombinationWrench : ToolBase , ITools
{
    ...
    public int controllerRotCount;
    public int boltRotCount;
    public float pervContAngle, curContAngle, curBoltAngle, speed;

    public float targetRotValue;
    ...
    void UseRatchetWrench()
    {
        if (isRotateReady)
        {
            ...
            // bolt 회전
            tr_bolt.LookAt(GetToolLookAtPos(direction));
    ...
    /*
    (float ss , int sss) aaa()
    {
        (float aa, int sss) sss;
        sss.aa = 12.2f;
        sss.sss = 1;
        return sss;
    }
