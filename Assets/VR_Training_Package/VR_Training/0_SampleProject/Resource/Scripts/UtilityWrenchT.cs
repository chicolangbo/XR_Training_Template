using UnityEngine;
public class UtilityWrenchT : MonoBehaviour
{
    #region Public Variable
    public int num = 0;
    public GameObject g_ratchet_M, g_ratchet_01, g_ratchet_02, g_ratchet_03, g_ratchet_04, g_ratchetP_01, g_ratchetP_02, g_ratchetP_03, g_ratchetP_04;
    public Transform socket21mm, tr_ratchet_01, tr_ratchet_02, tr_ratchet_03, tr_ratchet_04, xrController, tools;
    public float dir_between_M_01, dir_between_M_02, dir_between_M_03, dir_between_M_04, rot_between_M_01, rot_between_M_02, rot_between_M_03, rot_between_M_04, dir_distance_M_01, dir_distance_M_02, dir_distance_M_03, dir_distance_M_04, countTime = 0f;
    ...
    void SetPositionM_01()
    {
        ...
        g_ratchet_M.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
    }
    ...
    void SetPositionM_03()
    {
        g_ratchet_M.SetActive(false);
        g_ratchetP_03.SetActive(false);
        g_ratchet_03.SetActive(true);
        g_ratchet_M.transform.position = g_ratchetP_03.transform.position;
        g_ratchet_M.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
    }

    void SetPositionM_033()
    {
        g_ratchet_03.SetActive(false);
        g_ratchet_M.SetActive(true);
    }
    void SetPositionM_04()
    {
        g_ratchet_M.SetActive(false);
        g_ratchetP_04.SetActive(false);
        g_ratchet_04.SetActive(true);
        g_ratchet_M.transform.position = g_ratchetP_04.transform.position;
        g_ratchet_M.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
    }

    void SetPositionM_044()
    {
        g_ratchet_04.SetActive(false);
        g_ratchet_M.SetActive(true);
    }
    #endregion
    ...
    void distanceCal()
    {
        ...
        dirRatchet[3] = tr_ratchet_02.rotation * (tr_ratchet_02.forward + tr_ratchet_02.right);
        dirRatchet[4] = tr_ratchet_02.rotation * (tr_ratchet_02.forward + tr_ratchet_02.right);
