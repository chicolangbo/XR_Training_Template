...
public class SocketWithID_Tutorial_COPY : XRSocketInteractor
{
    ...
    protected override void OnSelectEntering(SelectEnterEventArgs args)
    {
        ...
        {
           wrench_using.transform.position = new Vector3 (setingPosition_using.transform.position.x - 0.1f, setingPosition_using.transform.position.y, setingPosition_using.transform.position.z);
           wrench_using.transform.rotation = wrench_using.transform.rotation * Quaternion.Euler(new Vector3(0f, 0f, -90f));
        }
        if (socket_21mm != null)
        {
            socket_21mm.transform.position = new Vector3(setingPosition_using.transform.position.x - 0.1f, setingPosition_using.transform.position.y, setingPosition_using.transform.position.z);
            //socket_21mm.transform.rotation = setingPosition_using.transform.rotation * Quaternion.Euler(new Vector3(0f, 0f, 0f));
        }
