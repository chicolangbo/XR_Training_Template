...
public class Pattern_093 : PatternBase
{
    int currentIndex;
    ...
    public override void MissionClear()
    {
        ...
        //볏겨주기
        BOX_1.gameObject.SetActive(false);
        BOX_2.gameObject.SetActive(false);
        ColliderEnable(goalData.p1_partsDatas[0].PartsIdObj, false); //콜라이더꺼주기
        SocketEnable(goalData.p1_partsDatas[0].PartsIdObj, false);
        ColliderEnable(goalData.p2_partsDatas[0].PartsIdObj, false); //콜라이더꺼주기
        SocketEnable(goalData.p2_partsDatas[0].PartsIdObj, false);
        EnableHighLightSlot(false);
        Scenario_EventManager.instance.RunEvent(CallBackEventType.TYPES.OnMissionClear);
        EnableEvent(false);
        goalData.p1_partsDatas[0].PartsIdObj.gameObject.SetActive(false);
        ResetGoalData();
    }
    ...
    public override void EventStart(Mission_Data missionData)
    {
        ...
        //if(goalData.p1_partsDatas[0].partsId == 266)  //고전압차단 두번째꺼 안켜져서 예외처리
        //{
        ...
        BOX_1 = goalData.p1_partsDatas[0].PartsIdObj.gameObject.transform.Find("BOX");
        BOX_2 = goalData.p1_partsDatas[0].PartsIdObj.gameObject.transform.Find("BOX2");

        Debug.Log("bbbbbbbbbbbb 1 : " + BOX_1);
        Debug.Log("bbbbbbbbbbbb 2 : " + BOX_2);
        //타겟 슬랏일경우 슬랏하이라이터 on 
