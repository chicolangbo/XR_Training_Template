...
public class Pattern_056 : PatternBase
{
    PartsID goalData1;
    ...
    void OnCollderEventStay(Collider col, PartsID partsID)
    {
        if (enableEvent)
        {
            ...
            //Debug.Log("Part ID : " + goalData1.id);
            //Debug.Log("breakIcon.id : " + breakIcon.id);
            //Debug.Log("goalData1.partType ID : " + goalData1.partType);
            //Debug.Log(" breakIcon.partType : " + breakIcon.id);
