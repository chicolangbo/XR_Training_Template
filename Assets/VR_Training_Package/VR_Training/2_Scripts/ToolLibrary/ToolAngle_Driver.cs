...
public class ToolAngle_Driver : Tool_AngleBase
{
    ...
    void Update()
    {
        if (isRotateReady)
        {
            ...
            //direction = toolDirType == EnumDefinition.ToolDirType.forward ? (int)curAngle - (int)prevAngle : (int)prevAngle - (int)curAngle;
            ...
            if (direction != 0)
            {
                ...
                Debug.Log($"prevDir {prevDir} direction {direction} isForwardDir {isForwardDir}");
            ...
            if (isForwardDir)
            {
                ...
                var speedValue = toolDirType == EnumDefinition.ToolDirType.forward ? curAngle - prevAngle : prevAngle - curAngle;
                ...
                if (isFakeWrench == false)
                {
                    ...
                    var calcProgress = UtilityMethod.Remap(totalRotValue * 2, 0f, targetRotValue, 0, 100f);
   ...
   */
    ...
    public void EnableTool_Socket(PartsID partsID)
    {
